...
//密码验证
 jQuery.validator.addMethod("isRightPassword", function(value, element) {
    var length = value.length;
   return this.optional(element) || /^[\s\S]{6,20}$/.test(value);
 }, "<span class='error'>请输入6-20位密码</span>");

//严格密码验证
 jQuery.validator.addMethod("isStrictPassword", function(value, element) {
    var length = value.length;
   return this.optional(element) || /([0-9].*([a-zA-Z].*[`~!@#\$%\^&\*\(\)_\+\-\\=\[\]\|\}\{;',\.\/":\?><]|[`~!@#\$%\^&\*\(\)_\+\-\\=\[\]\|\}\{;',\.\/":\?><].*[a-zA-Z])|[a-zA-Z].*([0-9].*[`~!@#\$%\^&\*\(\)_\+\-\\=\[\]\|\}\{;',\.\/":\?><]|[`~!@#\$%\^&\*\(\)_\+\-\\=\[\]\|\}\{;',\.\/":\?><].*[0-9])|[`~!@#\$%\^&\*\(\)_\+\-\\=\[\]\|\}\{;',\.\/":\?><].*([0-9].*[a-zA-Z]|[a-zA-Z].*[0-9]))/.test(value);
 }, "<span class='error'>输入的密码必须包含数字、字母和特殊字符</span>");