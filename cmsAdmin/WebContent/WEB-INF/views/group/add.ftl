...
<div class="main">
	<div class="rhead">
  	...
  	<div class="formBox mt10">
    	<h3><i></i><span><@s.m "cmsGroup.function"/><@s.m "global.add"/></span></h3>
    	<form action="${appServer.get('/group/add.htm')}" id="inputForm" method="POST">
	    	...
	    	<div class="content">
	      		<table class="c2">
		     		<tr>
			      		...
			      		<td>
			      			<input name="groupName" type="text" maxlength="20" class="inpt" />
		      				<span class="red">*</span>
			      	...
			      	<tr>
			      		...
			      		<td>
			      			<input name="code" type="text" maxlength="20" class="inpt" />
		      				<span class="red">*</span>
							<span class="error"></span>
			      		</td>
			      	</tr>
		     		<tr>
			      		...
			      		<td>
			      			<input name="priority" type="text" maxlength="20" class="inpt" />
		      				<span class="red">*</span>
							<span class="error"></span>
			      		</td>
		     		</tr>
		     		<tr>
			      		...
			      		<td>
			      			<input name="allowPerDay" type="text" maxlength="20" class="inpt" />
		      				<span class="red">*</span>
		     		...
		     		<tr>
				      	...
				      	<td>
		      				<input name="allowMaxFile" type="text" maxlength="20" class="inpt" />
		      				<span class="red">*</span>
		    		...
		    		<tr>
		      			...
		      			<td>
		      				<input name="allowSuffix"  type="text" maxlength="20" class="inpt" />
		      				<span class="red">*</span>
    		...
    		<div class="form-but">
    			<#--<#if settlerAgent.access("PermissionEnum.GROUP_ADD")>-->
      			<button id="buttonSave" type="button" class="button-s4" onclick="$('#inputForm').submit();"><@s.m "global.submit"/></button>
      			<#--</#if>-->
