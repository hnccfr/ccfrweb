...
<div class="main">
	<div class="rhead">
		<!-- 当前位置 -->
 		<div class="rpos">
 			<@s.m "global.position"/>: <@s.m "cmsAdvertising.function"/> - <@s.m "global.add"/>
 		</div>
		<div class="clear"></div>
	</div>
  	<div class="formBox mt10">
    	<h3><i></i><span>广告添加</span></h3>
    	<form action="${appServer.get('/adv/add.htm')}" id="inputForm" method="POST">
	    	...
	    	<div class="content">
	      		<table class="c2">
		    		...
		    		<tr>
		      			<th>是否默认显示：</th>
		      			<td>
		    				<input name="isDefault" type="radio" class="radio" value="2" checked />默认显示
		    				&nbsp;&nbsp;
		    				<input name="isDefault" type="radio" class="radio" value="1" />非默认显示
		     		...
		     		<tr>
		      			<th>标题：</th>
		      			<td>
		      				<input name="title" type="text" maxlength="120" class="inpt" />
							<span class="error"></span>
		      			</td>
		     		</tr>
		     		<tr>
		      			<th>url：</th>
		      			<td>
		      				<input name="link" type="text" maxlength="200" class="inpt" />
		      				<span class="red">*</span>
							<span class="error"></span>
		      			</td>
		     		</tr>
				    <tr style="display:none;">
				      	...
				      	<td>
				      		<input name="width" type="text" maxlength="4" class="inpt" />
							<span class="error"></span>
				      	</td>
			     	</tr>
		     		<tr style="display:none;">
		      			...
		      			<td>
		      				<input name="height" type="text" maxlength="4" class="inpt" />
							<span class="error"></span>
		      			</td>
		     		</tr>
		     		<tr style="display:none;">
		      			<th>展示次数：</th>
		      			<td>
		      				<input name="displayCount" type="text" maxlength="120" class="inpt" />
							<span class="error"></span>
		      			</td>
		     		</tr>
		     		<tr style="display:none;">
		      			<th>点击次数：</th>
		      			<td>
		      				<input name="clickCount" type="text" maxlength="120" class="inpt" />
							<span class="error"></span>
		      			</td>
		     		</tr>
		     		<tr id="attachRes">
