...
<div class="main">
	<div class="rhead">
		<!-- 当前位置 -->
 		<div class="rpos">
 			<@s.m "global.position"/>: <@s.m "cmsFriendlinkCtg.function"/> - <@s.m "global.add"/>
 		</div>
		<div class="clear"></div>
	</div>
  	<div class="formBox mt10">
    	<h3><i></i><span><@s.m "cmsFriendlinkCtg.function"/><@s.m "global.add"/></span></h3>
    	<form action="${appServer.get('/linkctg/add.htm')}" id="inputForm" method="POST">
